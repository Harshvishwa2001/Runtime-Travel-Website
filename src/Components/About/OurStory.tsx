...
export default function OurStory() {
    return (
        <div className='grid grid-cols-2 py-30 px-44.25 gap-18'>
            <div className='space-y-12'>
                ...
                <h2 className="text-[58px] w-lg leading-14">Where every journey begins with a <span className="text-[#C8913A] italic">conversation.</span>
                </h2>
                <div className="relative inline-block">
                    <div className="overflow-hidden">
                        <Image
                            ...
                            width={500}
                            height={552}
                            className="object-contain -ml-10 h-138 display-block"
                        />
                    </div>

                    <div className="absolute right-0 -bottom-8 bg-[#C8913A] text-white p-8 w-30 h-30 flex flex-col justify-center items-center">
            ...
            <div>
                <p className='text-[18px] tracking-widest font-secondary text-[#585250] leading-8'>
                ...
                <p className='bg-[#F7F4F0] border-l-2 border-[#C8913A] px-6 py-5 italic text-[18px]'>
