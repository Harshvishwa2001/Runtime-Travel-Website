...
export default function StoryBehind() {
    return (
        <div className='px-4 lg:px-25 py-6 lg:py-18.75 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12.5'>
            <div className='px-6'>
                <Image src={'/Blog/Images/story.png'} alt='Story' width={1000} height={1000} className='h-110 rounded-2xl lg:rounded-[10px] object-fill object-top' />
            </div>
            <div>
                <div className='space-y-3.5 border-b border-[#D6D6D6] pb-10'>
                    <h2 className='text-2xl lg:text-[48px] text-[#0D0D0D]'>The Faces and Stories Behind </h2>
                    <p className='text-sm lg:text-[16px] text-[#808080]'>Discover the inspiration behind our travel blog, where we share captivating stories and hidden gems from around the globe. Join us as we explore diverse cultures, breathtaking landscapes, and unforgettable experiences.</p>
                    <Button text='Get Started' className='text-[16px] text-white bg-[#243665] shadow-xs shadow-[#1018280D]' />
                </div>
                <div className='lg:flex gap-12 lg:gap-8 items-center justify-between py-4 lg:py-8'>
                    {
